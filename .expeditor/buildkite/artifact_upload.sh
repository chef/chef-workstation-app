...
- :macos_m1: https://packages.chef.io/files/${CHANNEL}/\/${VERSION}/chef-workstation-app-${VERSION}-darwin-arm64.zip
- :macos: https://packages.chef.io/files/${CHANNEL}/\/${VERSION}/chef-workstation-app-${VERSION}-darwin-x64.zip
